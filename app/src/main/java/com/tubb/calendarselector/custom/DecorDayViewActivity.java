...
public class DecorDayViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_decor);
        ...
        selector.setSegmentSelectListener(new SegmentSelectListener() {
            ...
            public boolean onInterceptSelect(FullDay selectingDay) {
                if(SCDateUtils.isToday(selectingDay.getYear(), selectingDay.getMonth(), selectingDay.getDay())){
                    Toast.makeText(DecorDayViewActivity.this, "Today can't be selected", Toast.LENGTH_SHORT).show();
                    return true;
                }
            ...
            public boolean onInterceptSelect(FullDay startDay, FullDay endDay) {
                ...
                if(differDays > 15) {
                    Toast.makeText(DecorDayViewActivity.this, "Selected days can't more than 15", Toast.LENGTH_SHORT).show();
                    return true;
                }
    ...
    private void intervalMode(){
        ...
        selector.setIntervalSelectListener(new IntervalSelectListener() {
            ...
            public boolean onInterceptSelect(List<FullDay> selectedDays, FullDay selectingDay) {
                if(selectedDays.size() >= 15) {
                    Toast.makeText(DecorDayViewActivity.this, "Selected days can't more than 15", Toast.LENGTH_LONG).show();
                    return true;
                }
